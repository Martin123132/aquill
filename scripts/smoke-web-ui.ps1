...
Assert-Contains -Text $AppBundle -Needle "transcript-editor-toolbar" -Label "Compiled app"
Assert-Contains -Text $AppBundle -Needle "Split at cursor" -Label "Compiled app"
Assert-Contains -Text $AppBundle -Needle "Replace all" -Label "Compiled app"
