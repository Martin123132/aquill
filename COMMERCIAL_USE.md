...
- Hobby, study, research, testing, and private local transcription.
- Noncommercial educational, charitable, public research, public safety, health, environmental protection, or government use covered by the license.
- Sharing source code or modified source code under the same license terms and required notices.
...
The project is meant to stay free for normal people running local tools on their own machines, while preventing companies from turning community work into another subscription product.
